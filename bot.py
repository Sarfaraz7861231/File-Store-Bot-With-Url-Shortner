    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://t.me/HelpChannel_VIP")
                    ],
                    [
                    ...
                    [
                        ...
                        InlineKeyboardButton("YouTube Channel", url="https://youtube.com/@sarfarazzr99?si=i_EHZTIgv8xAisHA")
                    ]
                ]
            )
        )
